...
nohup go run /data/www/web/go/src/github.com/hunterhug/AmazonBigSpider/spiders/usa/asinmain.go  > /data/www/web/go/src/github.com/hunterhug/AmazonBigSpider/sh/usa/asinmain.log 2>&1 &