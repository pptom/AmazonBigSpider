...
nohup go run /data/www/web/go/src/github.com/hunterhug/AmazonBigSpider/spiders/usa/ippool.go  > /data/www/web/go/src/github.com/hunterhug/AmazonBigSpider/sh/usa/ippool.log 2>&1 &