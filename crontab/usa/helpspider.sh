...
nohup go run /data/www/web/go/src/github.com/hunterhug/AmazonBigSpider/spiders/usa/listmain.go  > /data/www/web/go/src/github.com/hunterhug/AmazonBigSpider/sh/usa/listmain.log 2>&1 &