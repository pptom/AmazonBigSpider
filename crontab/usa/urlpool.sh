...
nohup go run /data/www/web/go/src/github.com/hunterhug/AmazonBigSpider/spiders/usa/urlpool.go  > /data/www/web/go/src/github.com/hunterhug/AmazonBigSpider/sh/usa/urlpool.log 2>&1