...
nohup go run /data/www/web/go/src/github.com/hunterhug/AmazonBigSpider/spiders/jp/ippool.go  > /data/www/web/go/src/github.com/hunterhug/AmazonBigSpider/sh/jp/ippool.log 2>&1 &