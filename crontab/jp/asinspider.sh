...
nohup go run /data/www/web/go/src/github.com/hunterhug/AmazonBigSpider/spiders/jp/asinmain.go  > /data/www/web/go/src/github.com/hunterhug/AmazonBigSpider/sh/jp/asinmain.log 2>&1 &