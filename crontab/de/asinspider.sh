...
nohup go run /data/www/web/go/src/github.com/hunterhug/AmazonBigSpider/spiders/de/asinmain.go  > /data/www/web/go/src/github.com/hunterhug/AmazonBigSpider/sh/de/asinmain.log 2>&1 &